...
import com.example.tenthskate.stockinventor.Activity.Activity_stocksupplied_Confirm_Addcomment;
...
public class stocksupplied_confirmAddComment_Adapter extends RecyclerView.Adapter<stocksupplied_confirmAddComment_Adapter.ProductsViewHolder> {
    private Context mContext;
    private List<Upload> mUploads;

    DatabaseReference allProducts = FirebaseDatabase.getInstance().getReference().child("all_confirmed_supplies");
    //DatabaseReference categoryProducts = FirebaseDatabase.getInstance().getReference().child("SupplierCategory");


    public stocksupplied_confirmAddComment_Adapter(Context context, List<Upload> uploads)
    {
        mContext=context;
        mUploads=uploads;
    }
    ...
    public ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(mContext).inflate(R.layout.stocksupplied_addcomment, viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull ProductsViewHolder productsViewHolder, final int i) {
        ...
        productsViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent manageProductIntent = new Intent(mContext, Activity_stocksupplied_Confirm_Addcomment.class);
    ...
    public static class ProductsViewHolder extends RecyclerView.ViewHolder{
        public TextView product_name, quantity,status,amount, suppliername,description;
