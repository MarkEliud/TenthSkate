...
public class Upload {
    ...
    public Upload(String productName, String productCode,
                  String productDescription, String productImageUrl,
                  String productCategory, String productPrice, String ProductCuttedPrice,
                  String productID, String searchableName,String quantity) {
