...
public class updatesuppliedStock extends AppCompatActivity {
    ...
    private String productID, retProductCategory,suppliedquantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        suppliedquantity = Objects.requireNonNull(Objects.requireNonNull(getIntent().getExtras()).get("quantity")).toString();
        loadingBar=new ProgressDialog(updatesuppliedStock.this);
    ...
    private void updateInformation() {
        ...
        if (quenty.getText().toString().isEmpty()){
            ...
            loadingBar.show();
              ...
              int suppliedstock = Integer.parseInt(suppliedquantity.trim());
            int existingstock = Integer.parseInt(quenty.getText().toString().trim());
            int sum = suppliedstock + existingstock;
            ...
            categoryRef.child(retProductCategory).child(productID).child("quantity").setValue(sum);
            ...
            productsRef.child(productID).child("quantity").setValue(sum);
    ...
    private void sendUserToMainActivity() {
        Intent mainIntent=new Intent(updatesuppliedStock.this,MainActivity.class);
