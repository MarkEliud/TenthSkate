...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.ProductsViewHolder> {
    ...
    DatabaseReference categoryProducts = FirebaseDatabase.getInstance().getReference().child("all_confirmed_supplies_SupplierCategory");
    ...
    public void onBindViewHolder(@NonNull ProductsViewHolder productsViewHolder, final int i) {
        ...
        if(uploadCur.getStatus().equals("Complete")){
            productsViewHolder
                    .sta.setText("Waiting for Payment");
