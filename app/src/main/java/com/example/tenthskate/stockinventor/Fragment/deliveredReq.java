...
import com.example.tenthskate.stockinventor.Adapter.confirmsuppliesUpdateStockAdapter;
...
public class deliveredReq extends Fragment{
    ...
    private confirmsuppliesUpdateStockAdapter mAdapter;
...
//        });
        ...
        Query query = mDatabaseProductsRef.orderByChild("status").equalTo("inveApproved");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mAdapter=new confirmsuppliesUpdateStockAdapter(fragmentActivity, mUploads);
