...
public class reqProductsAdapter extends RecyclerView.Adapter<reqProductsAdapter.ProductsViewHolder> {
    ...
    public reqProductsAdapter(Context context, List<Upload> uploads)
    {
        mContext=context;
        mUploads=uploads;
    }
    ...
    public void onBindViewHolder(@NonNull ProductsViewHolder productsViewHolder, final int i) {
        ...
        productsViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(mContext, "Delivered history activity", Toast.LENGTH_SHORT).show();
