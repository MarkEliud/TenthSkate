...
import com.example.tenthskate.Supplier.Activity.supplyrequests;
...
public class requestApprove extends RecyclerView.Adapter<requestApprove.ProductsViewHolder> {
    ...
    DatabaseReference allProducts = FirebaseDatabase.getInstance().getReference().child("allRequests").child(Prevalent.currentOnlineSupplier.getName());
    ...
    public void onBindViewHolder(@NonNull ProductsViewHolder productsViewHolder, final int i) {
        ...
        productsViewHolder.quantity.setText(uploadCur.getQuantity());
       ...
       productsViewHolder.mpesa.setText(uploadCur.getMpesa());
        productsViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent manageProductIntent = new Intent(mContext, supplyrequests.class);
    ...
    public static class ProductsViewHolder extends RecyclerView.ViewHolder{
        public TextView product_name, quantity,status, mpesa,description;
