 ...
 */
public class delivsFragment extends Fragment{

    private RecyclerView mRecyclerView;
    private reqProductsAdapter mAdapter;

    private ProgressBar progressBar;

    private List<Upload> mUploads;

    public delivsFragment() {
    }
...
//        });
        ...
        //todo modify db
        final DatabaseReference mDatabaseProductsRef = FirebaseDatabase.getInstance().getReference("allRequests").child(Prevalent.currentOnlineSupplier.getName());
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter=new reqProductsAdapter(fragmentActivity, mUploads);
