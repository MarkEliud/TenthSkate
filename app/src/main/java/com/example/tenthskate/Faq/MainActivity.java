...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Tenth Empire Help & Faqs");
        findViewById();
    }
    ...
    private ArrayList<Faq> getFaqs() {
        ...
        faqs.add(new Faq("Payments?",
                "Make orders with your phone number using the mpesa gateway" +
                        "Tenth Empire will send information on the number of total expenditures " +
                        "and postage to your email address, for details please check your email!"));

        faqs.add(new Faq("Shipping?",
                "Product prices do not include shipping costs, shipping costs are constant " +
                        "and does not depend on the volume of goods, destination address and courier used."));
