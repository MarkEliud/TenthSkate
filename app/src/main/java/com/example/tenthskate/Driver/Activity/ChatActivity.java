...
import com.example.tenthskate.Clients.Adapter.ChatAdapter;
import com.example.tenthskate.Clients.Adapter.ChatMessage;
...
//import in.Rumishe.AppMain.Adapter.ChatAdapter;
//import in.Rumishe.AppMain.Adapter.ChatMessage;
...
public class ChatActivity extends AppCompatActivity {
    ...
    String rece =LoginActivity.ip+"public/loadmessages.php";
    // String send = LoginActivity.ip+"sendmessage.php";
    String send =LoginActivity.ip+"public/sendmessage.php";
//    String rece = LoginActivity.ip+"loadmessages.php";
//    String send = LoginActivity.ip+"sendmessage.php";
    @Override
