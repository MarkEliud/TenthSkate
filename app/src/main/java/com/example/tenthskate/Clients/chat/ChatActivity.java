package com.example.tenthskate.Clients.chat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    String choice,current,sender,email,name,smail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current = intent.getStringExtra("receiver");
    ...
    private void loadChatMessages() {
       // StringRequest request = new StringRequest(Request.Method.GET, rece +"?sender_id="+ smail + "&receiver_id=" + email,
                StringRequest request = new StringRequest(Request.Method.GET, rece +"?sender_id="+ smail + "&receiver_id=" + email,
      ...
      //  String url = "http://localhost/send_message.php";
        StringRequest request = new StringRequest(Request.Method.POST, send,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user", choice);
                params.put("email", email);
                params.put("name", name);
                params.put("smail", smail);
                return params;
            }
        };
        Volley.newRequestQueue(this).add(request);
