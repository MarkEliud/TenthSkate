            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        ...
                        selectedUrl=LoginActivity.ip+"RegisterDriver.php";
                    ...
                    case 2:
                        ...
                        selectedUrl=LoginActivity.ip+"users/data-inventory.php";
                        address1.setVisibility(View.GONE);
...
//
                    ...
                    case 3:
                        choice = String.valueOf(spinner.getAdapter().getItem(i));
                        selectedUrl=LoginActivity.ip+"users/data-finance.php";
                        address1.setVisibility(View.GONE);
                        mobile.setVisibility(View.GONE);
                        radioGroup.setVisibility(View.GONE);
...
//
                    ...
                    case 4:
                        choice = String.valueOf(spinner.getAdapter().getItem(i));
                        selectedUrl=LoginActivity.ip+"users/data-supplier.php";
                        address1.setVisibility(View.GONE);
                        mobile.setVisibility(View.GONE);
                        radioGroup.setVisibility(View.GONE);
...
//
                                        ...
                                        registersupplier(selectedUrl,user_name+" "+secName,email,txt_password,choice);
                                    }
                                }
                    ...
                    case 5:
                        choice = String.valueOf(spinner.getAdapter().getItem(i));
                        selectedUrl=LoginActivity.ip+"users/data-care.php";
                        address1.setVisibility(View.GONE);
                        mobile.setVisibility(View.GONE);
                        radioGroup.setVisibility(View.GONE);
...
//
                    ...
                    case 6:
                        choice = String.valueOf(spinner.getAdapter().getItem(i));
                        selectedUrl=LoginActivity.ip+"users/data-shipment.php";
                        address1.setVisibility(View.GONE);
                        mobile.setVisibility(View.GONE);
                        radioGroup.setVisibility(View.GONE);
...
//
    ...
    //register supplier in mysql

    private void registersupplier(String url1,final String username,final String email,
                              final String pass,final String position) {
        if (email.length() > 1) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url1, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (response.equals(" Records Inserted")) {
                        registersupp(username,email,pass);
...
//                    param.put("address", address);
    ...
    private void registersupp(final String name, final String email, String pwd) {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            DatabaseReference databaseS2 = database.getReference("employee").child("Suppliers").child(userName);
                            ...
                            databaseS2.child("email").setValue(email)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            showSnackbar("Successfully created your Supplier's Account", Color.GREEN);
                                            startActivity(new Intent(RegisterActivity.this, LoginActivity.class));
                                    ...
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            showSnackbar("Error: Could not save supplier information", Color.RED);
                                            Log.e("Firebase", "Error saving supplier information", e);
                                        }
                                    });
                        } else {
                            showSnackbar("Error: Could not create user account", Color.RED);
    ...
    private void registerD(final String username,final String secName,
        ...
        if (mobile.length() == 10) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST,
                    LoginActivity.ip+"RegisterDriver.php",
    ...
    private void register(final String username,final String secName, final String email, final String password, final String mobile, final String gender,final  String address) {
        if (mobile.length() == 10) {
           ...
           progressDialog.show();
            ...
            StringRequest request = new StringRequest(Request.Method.POST,
                    LoginActivity.ip+"insert.php", new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
